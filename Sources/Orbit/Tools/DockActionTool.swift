...
final class DockActionTool: Tool {
    ...
    func run(input: [String: String]) async throws -> String {
        ...
        case "add":
            ...
            """])
            try await scriptExecutor.runShell("defaults write com.apple.dock persistent-apps -array-add '{\"tile-type\"=\"file-tile\";\"file-data\"={\"_CFURLString\"=\"file:///Applications/\(appName).app/\";\"_CFURLStringType\"=15;}}' && killall Dock")
